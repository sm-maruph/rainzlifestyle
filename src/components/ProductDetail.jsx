      ...
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <button onClick={() => toggle(product)} aria-label="Wishlist" className="rounded-md border border-gray-200 px-3 transition-colors hover:border-gray-300" style={{ color: wished ? BRAND : "#6b7280" }}>
